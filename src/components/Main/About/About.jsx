  ...
  <section className="aboutWrapper" id='about'>
      <article className="aboutContainer">
        ...
        <p>Actualmente busco mi primer empleo como desarrollador web ya que recientemente me he graduado 
          en <i><a className='links' href="https://www.thebridge.tech/bootcamps/bootcamp-fullstack-developer" target="_blank">The Bridge</a></i> como 
          full-stack developer después de 4 meses intensos de formación, además de varios meses aprendiendo como autodidacta antes de dicho curso. 
